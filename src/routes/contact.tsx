...
const WHATSAPP_NUMBER = "212672492366";
const NAME_MAX = 100;
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-xl mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <button
              type="submit"
              className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl bg-[#25D366] text-white font-bold text-lg hover:opacity-90 transition-opacity"
            >
